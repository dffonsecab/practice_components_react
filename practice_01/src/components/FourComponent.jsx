...
const FourComponent = () => {
  ...
  return (
    <div>
        ...
        {/* Evento Click*/}
        <div> <button className='btn btn-danger' onClick={nombre}>Haz Click</button></div>
    
        <div><button className='btn btn-success' onClick={e=>handledClicked(e,"Diego")}>Aqui tambien haz click</button></div>

        <div> <button className='btn btn-info' onDoubleClick={handleDoubleClicked}>Haz Doble Click</button></div>

        <div> <button className='btn btn-info' onMouseOver={handleDoubleClicked}>Haz Doble Click</button></div>




        <div id="box1" onMouseEnter={e=>handlerMouseEnter(e)}
            onMouseLeave={e=>handleMouseLeave(e,)}>
            
            <p>Pasa el mouse por encima</p>
        </div>

        <div id="box2" className='mt-4' onMouseEnter={e=>handleMouse(e,"Entrado")} 
